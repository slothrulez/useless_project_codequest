...
export const LearnCodexModal: React.FC<LearnCodexModalProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div
        id="learn-codex-box"
        className="relative w-full max-w-2xl bg-stone-900 border-4 border-amber-800/90 rounded-xl shadow-2xl p-4 sm:p-6 text-stone-200 overflow-hidden font-pixelated"
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-stone-800 pb-3 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xs sm:text-sm font-pixel text-amber-300">GIT CODEX & SPELLBOOK</h2>
              <p className="text-[10px] font-pixelated text-stone-400">Sacred knowledge of distributed version control</p>
            </div>
          </div>
          <button
            onClick={() => {
        ...
        {/* Navigation Tabs */}
        <div className="flex border-b border-stone-800 mb-4 gap-1 text-[9px] font-pixel overflow-x-auto pb-1">
          <button
            onClick={() => {
        ...
        {/* Content Section */}
        <div className="max-h-72 overflow-y-auto pr-1 text-xs font-pixelated">
          {activeTopic === 'basics' && (
            <div className="space-y-3">
              <div className="p-3 bg-stone-950 border border-stone-800 rounded-lg">
                <div className="font-pixel text-[10px] text-amber-300 mb-2">1. WORKING DIRECTORY (Files on Disk)</div>
                <p className="text-stone-300 text-[11px] leading-relaxed">
                  Your sandbox where you write code and edit files. These changes are volatile until added to the index.
                </p>
              </div>

              <div className="text-center font-pixel text-stone-400 text-[9px]">&#8595; git add &#8595;</div>
              ...
              <div className="text-center font-pixel text-emerald-400 text-[9px]">&#8595; git commit &#8595;</div>

              <div className="p-3 bg-stone-950 border border-stone-800 rounded-lg">
                <div className="font-pixel text-[10px] text-emerald-300 mb-2">3. REPOSITORY (Immutable History)</div>
                <p className="text-stone-300 text-[11px] leading-relaxed">
          ...
          {activeTopic === 'branching' && (
            <div className="space-y-3">
              <div className="p-3 bg-stone-950 border border-stone-800 rounded-lg">
                <div className="font-pixel text-[10px] text-amber-300 mb-1">BRANCHES ARE LIGHTWEIGHT POINTERS</div>
                <p className="text-stone-300 text-[11px] leading-relaxed">
              ...
              <div className="p-3 bg-stone-950 border border-stone-800 rounded-lg">
                <div className="font-pixel text-[10px] text-stone-200 mb-1">FAST-FORWARD vs 3-WAY MERGE</div>
                <p className="text-stone-300 text-[11px] leading-relaxed">
          ...
          {activeTopic === 'rebase' && (
            <div className="space-y-3">
              <div className="p-3 bg-stone-950 border border-stone-800 rounded-lg">
                <div className="font-pixel text-[10px] text-amber-300 mb-1">GIT REBASE: THE TIMELINE RE-WRITER</div>
                <p className="text-stone-300 text-[11px] leading-relaxed">
              ...
              <div className="p-3 bg-stone-950 border border-rose-900/60 rounded-lg">
          ...
          {activeTopic === 'cheatsheet' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px]">
              <div className="p-2 bg-stone-950 rounded border border-stone-800">
                <div className="font-pixel text-[9px] text-amber-400">git status</div>
                <div className="text-stone-400 text-[10px] mt-0.5">Show working tree status</div>
              </div>
              <div className="p-2 bg-stone-950 rounded border border-stone-800">
                <div className="font-pixel text-[9px] text-amber-400">git add -A</div>
                <div className="text-stone-400 text-[10px] mt-0.5">Stage all modified/untracked files</div>
              </div>
              <div className="p-2 bg-stone-950 rounded border border-stone-800">
                <div className="font-pixel text-[9px] text-amber-400">git commit -m &quot;...&quot;</div>
                <div className="text-stone-400 text-[10px] mt-0.5">Record changes with message</div>
              </div>
              <div className="p-2 bg-stone-950 rounded border border-stone-800">
                <div className="font-pixel text-[9px] text-amber-400">git log --graph --oneline</div>
                <div className="text-stone-400 text-[10px] mt-0.5">Visual commit lineage tree</div>
              </div>
              <div className="p-2 bg-stone-950 rounded border border-stone-800">
                <div className="font-pixel text-[9px] text-amber-400">git stash pop</div>
                <div className="text-stone-400 text-[10px] mt-0.5">Restore shelved work from stash</div>
              </div>
              <div className="p-2 bg-stone-950 rounded border border-stone-800">
                <div className="font-pixel text-[9px] text-amber-400">git diff</div>
                <div className="text-stone-400 text-[10px] mt-0.5">Show unstaged line changes</div>
              </div>
            </div>
          )}
        </div>
